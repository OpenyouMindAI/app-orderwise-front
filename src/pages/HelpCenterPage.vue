  ...
  <q-page class="help-center-page">
    ...
    <div class="help-center-content q-pa-md">
      ...
      <div v-else>
        ...
        <!-- Feedback section -->
        <div class="help-feedback-section q-pa-lg text-center rounded-borders q-mb-xl">
          <div class="text-body1 text-weight-medium q-mb-sm">¿Te resulta útil el centro de ayuda?</div>
          <div class="row justify-center q-gutter-sm">
            <q-btn flat round icon="thumb_up" color="grey-6" size="md" @click="sendFeedback('positive')" />
            <q-btn flat round icon="thumb_down" color="grey-6" size="md" @click="sendFeedback('negative')" />
          </div>
        </div>
...
function sendFeedback (type) {
  ...
  console.log('Help center feedback:', type)
}
</script>
