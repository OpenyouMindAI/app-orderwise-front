   ...
   <div class="q-pa-md">
    <div class="row q-col-gutter-sm">
      <div class="col-12 text-right">
        <q-btn color="primary" @click="openAddTypeOfService = true" icon="add_circle"/>
      </div>
     <div class="col-12">
      <q-table
      ...
      :filter="filter"
       ...
       @row-click="editTypeOfService"
       @request="setPagination"
       no-data-label="Regitro no encontrado"
     >
    ...
    <q-dialog v-model="openAddInvoiceType" persistent>
      <q-card style="width: 700px; max-width: 80vw;">
        <q-form @submit="saveInvoiceType">
          <q-card-section class="row items-center bg-primary text-white">
            <div class="text-h6">Agregar tipo de Servicios</div>
            <q-space />
            <q-btn icon="close" flat round dense @click="closeModal" />
          </q-card-section>
          <q-card-section class="row q-col-gutter-sm">
