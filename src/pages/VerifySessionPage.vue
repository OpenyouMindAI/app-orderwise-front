...
const getUser = async () => {
  try {
    // Decode the access_token if it comes encoded
    const accessToken = decodeURIComponent(route.params.access_token)
    const tokenType = decodeURIComponent(route.params.token_type)
